...
import type { ConsumableItem } from "@entities/Objects/types/consumables.type";

const ConsumablesSearch = () => {
	const { register, watch } = useForm<Partial<ConsumableItem>>();
...
export default ConsumablesSearch;
